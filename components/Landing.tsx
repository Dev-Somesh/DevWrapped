              ...
              <div className="space-y-3 text-left">
                ...
                {showTokenInfo && (
                  <div className="p-5 rounded-xl bg-[#0d1117] border border-[#30363d] text-[11px] text-[#8b949e] animate-in fade-in slide-in-from-top-2 duration-300">
                    <p className="font-black text-[#58a6ff] uppercase tracking-widest text-[9px] mb-1">Privacy_Protocol</p>
                    <p className="font-light leading-relaxed">Tokens allow high-speed analysis of private work. We discard tokens immediately after use.</p>
                  </div>
                )}
              </div>

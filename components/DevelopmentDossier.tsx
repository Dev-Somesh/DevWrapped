      ...
      >
        ...
        <section className="mt-20 pt-16 border-t border-[#30363d]/50">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-12">
            <div className="space-y-4">
              <h5 className="text-[11px] font-mono text-white/40 uppercase tracking-[0.5em] font-black">Reported by Dev-Wrapped</h5>
        ...
        <div className="mt-16 pt-12 border-t border-[#30363d]/30 flex flex-col md:flex-row justify-between items-center gap-8 opacity-20">
           <div className="flex items-center gap-4">
             ...
             <span className="text-[12px] font-mono tracking-[1em] font-black uppercase">DEV-WRAPPED // 2025</span>
           </div>
